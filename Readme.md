...
- 馃摴 **Download from 1700+ sites** - Powered by yt-dlp
- 馃寪 **Browser Capture Engine** - Intercepts video streams from ANY website
- 馃幆 **Smart Quality Selection** - Choose from 4K, 1080p, 720p, 480p, audio-only
- 馃搳 **Batch Downloads** - Queue multiple videos
- 馃梼锔� **Download History** - SQLite database tracking
- 馃帹 **Modern GUI** - Built with CustomTkinter
- 鈿� **Fast & Reliable** - Multi-threaded downloads
- 馃洃 **Cancel Support** - Stop downloads anytime
...
A professional-grade video downloader with an enterprise-level browser capture engine. Download videos from 1700+ sites including YouTube, Twitter, Instagram, Reddit, TikTok, Vimeo, and more鈥攅ven from unsupported sites using advanced stream interception.

## 鉁� Features

- 馃摴 **1700+ Supported Sites** - Powered by yt-dlp for YouTube, Twitter, Reddit, Facebook, and beyond
- 馃寪 **Browser Capture Engine** - Intercept and download video streams from ANY website using Playwright automation
- 馃幆 **Smart Quality Selection** - Dynamic detection of available qualities: 4K (2160p), 2K (1440p), 1080p, 720p, 480p, 360p, 240p, 144p, or audio-only
- 馃搳 **Batch Downloads** - Queue and process multiple URLs with consistent quality settings across all videos
- 馃梼锔� **Download History** - SQLite-based tracking with search, statistics, and export options
- 馃帹 **Modern GUI** - Sleek, dark-mode interface built with CustomTkinter for a native Windows experience
- 鈿� **Fast & Reliable** - Multi-threaded downloads with real-time progress, speed tracking, and automatic retry
- 馃洃 **Advanced Controls** - Cancel individual/batch downloads, pause/resume, and custom output paths
- 馃搧 **Smart Organization** - Automatic MP4 conversion, custom folders, and metadata embedding
- 馃敀 **Safe & Private** - No telemetry, local database, and secure browser sessions
...
4. **Note**: Antivirus may flag it as unknown鈥攕afe, but add exception if prompted
...
4. Click **"Download"**鈥攑rogress shows in real-time

### Batch Download
1. Switch to **Batch** tab
2. Add multiple URLs (one per line or paste list)
3. Set global quality and output path
4. Click **"Start Batch Download"**鈥攑rocesses sequentially with unified settings
...
- **Batch Quality**: Uses the selected quality for ALL videos鈥攇reat for consistent playlists
...
- **Antivirus blocks .exe**: Add exception鈥攊t's safe (open source!)
...
猸� **Star this repo if it helps you!** Questions? Join the [discussion](https://github.com/msd-sajjad007/ultimate-video-downloader/discussions).  

*Built with 鉂わ笍 by msd-sajjad007*
